class Solution(object):
    def robotSim(self, commands, obstacles):
        ...
        def move(point, direction, command):
            if direction == "N":
                for dy in range(command):
                    if point[1] + dy + 1 in x_obstacles[point[0]]:
                        return point[0], point[1] + dy
                return point[0], point[1] + command
            elif direction == "E":
                for dx in range(command):
                    if point[0] + dx + 1 in y_obstacles[point[1]]:
                        return point[0] + dx, point[1]
                return point[0] + command, point[1]
            elif direction == "S":
                for dy in range(command):
                    if point[1] - dy - 1 in x_obstacles[point[0]]:
                        return point[0], point[1] - dy
        ...
        for command in commands:
            if command == -2:
                ...
                point = move(point, direction, command)
...
commands = [9,-1,-2,6,-2,3,7,-1,-1,2]
obstacles = [[0,7],[1,7],[-2,7]]
