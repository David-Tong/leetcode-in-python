    ...
    def getAncestors(self, n, edges):
        ...
        for x in topology:
            for y in ancestors[x]:
                ancestors[x] = ancestors[x].union(ancestors[y])
        for x in range(n):
            ancestors[x] = sorted(ancestors[x])
        return ancestors
